...
var Connector = function (_React$Component) {
  ...
  _createClass(Connector, [{
    ...
    value: function componentWillMount() {
      ...
      var actions = _context$appstores.actions;
    ...
    value: function render() {
      ...
      var _context$appstores2 = this.context.appstores;
      var states = _context$appstores2.states;
      var actions = _context$appstores2.actions;

      if (component) {
        return _react2.default.createElement(component, _extends({}, props, this.actions, setProps(states, actions)));
      }
      if (children) {
